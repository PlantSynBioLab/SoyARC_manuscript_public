...
tau_df$tau <- apply(tau_df[, 4:17], 1, #one here indicates the function will be applied to each row
                    function(row) sum(1 - row) / 13)
...
tau_df_aerial$tau <- apply(tau_df_aerial[, 3:9], 1, #one here indicates the function will be applied to each row
                    function(row) sum(1 - row) / 6)
