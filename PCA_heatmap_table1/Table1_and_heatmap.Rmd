...
```{r}
# combine data frames expr_logic with tau values
expr_logic_PC2_3 <- cbind(expr_logic2, tau_df$tau)
...
```{r}
# combine data frames expr_logic with tau values
expr_logic_PC3_4 <- cbind(expr_logic3, tau_df$tau)
...
dat_TIR_PC1_2_7tissues <- data.frame(
  points[2:3], 
  in.ell_TIR = as.logical(point.in.polygon(points$x, points$y, ell_TIR_PC1_2_7tissues$x, ell_TIR_PC1_2_7tissues$y))
)

dat_IAA_PC1_2_7tissues <- data.frame(
  points[2:3], 
  in.ell_IAA = as.logical(point.in.polygon(points$x, points$y, ell_IAA_PC1_2_7tissues$x, ell_IAA_PC1_2_7tissues$y)) 
) 

dat_ARF_PC1_2_7tissues <- data.frame(
  points[2:3], 
  in.ell_ARF = as.logical(point.in.polygon(points$x, points$y, ell_ARF_PC1_2_7tissues$x, ell_ARF_PC1_2_7tissues$y))
)
# as.logical(point..) equals to TRUE indicated points are inside ellipses
